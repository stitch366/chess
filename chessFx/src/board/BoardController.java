...
public class BoardController extends AnchorPane {
		...
		public BoardController(String gf)
		{
			ChessGameData gd = new ChessGameData(gf);
			this.CurrentTurn = gd.CurrentTurn;
			this.chess = new ChessUtil(gd);
			FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/Chess.fxml"));
			fxmlLoader.setRoot(this);
			fxmlLoader.setController(this);
