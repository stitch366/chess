...
public class MoveSim {
	...
	MoveSim(HashMap<String, Piece> a, HashMap<String, Piece> e, ArrayList<String> eId, Space[][] sb, String kId, String mpId, String mpto)
	{
		ArrayList<String> allyids = (ArrayList<String>) a.keySet();
		for(int x = 0; x < allyids.size(); x++)
		{
			this.ally.put(allyids.get(x), new Piece(a.get(allyids.get(x))));
		}
		this.enemyId = (ArrayList<String>) eId.clone();
